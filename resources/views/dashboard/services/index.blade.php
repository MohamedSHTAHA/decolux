                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                                ...
                                <a href="{{ route('services.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add</a>
                        ...
                        @foreach ($services as $index=>$service)
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a href="{{ route('services.edit', $service->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
