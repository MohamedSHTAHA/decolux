...
<section id="subheader" data-speed="8" data-type="background"
    ...
    style="background-image: url('images/subheader-6-1.jpg');"
                    >
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul id="breadcrumbs" class="crumb"><li><a href="index.html">Home</a></li><li class="active">Contact</li></ul> 
            </div>
        </div>
    </div>
</section>
        ...
        @method('POST')
                                ...
                                <div class="wpforms-field-container">
                                    <div id="wpforms-1927-field_0-container" class="wpforms-field wpforms-field-name" data-field-id="0">
                                        ...
                                        <input type="text" id="wpforms-1927-field_0" class="wpforms-field-large wpforms-field-required" name="name" required></div>
                                    ...
                                    <div id="wpforms-1927-field_6-container" class="wpforms-field wpforms-field-text" data-field-id="6">
                                        ...
                                        <input type="text" id="wpforms-1927-field_6" class="wpforms-field-large wpforms-field-required" name="phone" required></div>
