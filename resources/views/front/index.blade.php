                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper ">
                        <div class="wpb_single_image wpb_content_element vc_align_left">
                            ...
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey">
                                    <img class="vc_single_image-img " src="{{ asset('front')}}/images/3-150x43.png" width="150" height="43" alt="3" title="3" />
                                </div>
                            </figure>
                        </div>
                    </div>
                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper ">
                        <div class="wpb_single_image wpb_content_element vc_align_left">
                            ...
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey">
                                    <img class="vc_single_image-img " src="{{ asset('front')}}/images/2-150x45.png" width="150" height="45" alt="2" title="2" />
                                </div>
                            </figure>
                        </div>
                    </div>
                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper ">
                        <div class="wpb_single_image wpb_content_element vc_align_left">
                            ...
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey">
                                    <img class="vc_single_image-img " src="{{ asset('front')}}/images/4-150x43.png" width="150" height="43" alt="4" title="4" />
                                </div>
                            </figure>
                        </div>
                    </div>
                ...
                <div class="vc_column-inner">
                    <div class="wpb_wrapper wow fadeInUp">
                        ...
                        <div class="de-team-list team-box wow fadeInUp">
                            <div class="team-pic">
                                <img width="500" height="500" src="{{ asset('front')}}/images/Decosoul.jpg" class="img-responsive" alt="" loading="lazy" srcset="{{ asset('front')}}/images/Decosoul.jpg" sizes="(max-width: 500px) 100vw, 500px" title="Decosoul" />
                            </div>
                            <div class="team-desc">
                                <h3></h3>
                        ...
                        <div class="de-team-list team-box wow fadeInUp">
                            <div class="team-pic">
                                <img width="500" height="500" src="{{ asset('front')}}/images/decofit-1.jpg" class="img-responsive" alt="" loading="lazy" srcset="{{ asset('front')}}/images/decofit-1.jpg" sizes="(max-width: 500px) 100vw, 500px" title="decofit" />
                            </div>
                            <div class="team-desc">
                                <h3></h3>
                                <div class="small-border"></div>
                                <p>DecoFit covers all interiors works with a wide range of Wall Covering, Floor covering, Acoustic cladding & ceiling, Office Furniture and provides a Fit-out services for all types of commercial and residential units with high quality products well tested to provide luxury and safe space.</p>
                                <div class="social">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="de-team-list team-box wow fadeInUp">
                            <div class="team-pic">
                                <img width="500" height="500" src="{{ asset('front')}}/images/decosport.jpg" class="img-responsive" alt="" loading="lazy" srcset="{{ asset('front')}}/images/decosport.jpg" sizes="(max-width: 500px) 100vw, 500px" title="VLUU L200  / Samsung L200" />
                            </div>
                            <div class="team-desc">
                                <h3></h3>
                                <div class="small-border"></div>
                        ...
                        <div class="de-team-list team-box wow fadeInUp">
                            <div class="team-pic">
                                <img width="500" height="500" src="{{ asset('front')}}/images/decosteel.jpg" class="img-responsive" alt="" loading="lazy" srcset="{{ asset('front')}}/images/decosteel.jpg" sizes="(max-width: 500px) 100vw, 500px" title="decosteel" />
                            </div>
                            <div class="team-desc">
                                <h3></h3>
                                <div class="small-border"></div>
