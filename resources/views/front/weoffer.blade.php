        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul id="breadcrumbs" class="crumb"><li><a href="index.html">Home</a></li>
                    ...
                    <li class="active">What We Offer</li></ul> 
            </div>
        </div>
    </div>
</section>
...
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-3">
            <div class="vc_column-inner">
                <div class="wpb_wrapper "  >
<div  class="wpb_single_image wpb_content_element vc_align_left">
    ...
    <figure class="wpb_wrapper vc_figure">
        <div class="vc_single_image-wrapper   vc_box_border_grey">
            <img class="vc_single_image-img " src="{{ asset('front') }}/images/3-150x43.png" width="150" height="43" alt="3" title="3" /></div>
    </figure>
</div>
</div>
